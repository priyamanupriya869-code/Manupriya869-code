//write a cprogram to display any code four car company details
//using nested structure and the element of the struct and company name , modle and price and manufature date
